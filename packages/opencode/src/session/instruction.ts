...
export interface Interface {
  ...
  readonly project: () => Effect.Effect<string[], AppFileSystem.Error>
...
export const layer: Layer.Layer<
  Service,
  never,
  AppFileSystem.Service | Config.Service | Global.Service | HttpClient.HttpClient | Memory.Service
> = Layer.effect(
  Service,
  Effect.gen(function* () {
    ...
    const project = Effect.fn("Instruction.project")(function* () {
    ...
    return Service.of({ clear, systemPaths, system, project, find, resolve })
  }),
)
