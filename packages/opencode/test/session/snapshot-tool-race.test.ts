...
const memory = Layer.succeed(
  ...
  Memory.Service.of({
    ...
    checkRules: () => Effect.succeed({ recognized: 0, total: 0, invalid: [], pathRules: [], technologyRules: [] }),
    editGuard: () => Effect.succeed({ ruleset: [], matches: [], severity: undefined }),
