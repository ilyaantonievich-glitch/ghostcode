  ...
  Instruction.layer.pipe(
    Layer.provide(
      Layer.succeed(
        Memory.Service,
        Memory.Service.of({
          root: () => Effect.succeed(path.join(global.config ?? global.home ?? ".", ".vibe")),
            ensure: () => Effect.die("unexpected memory.ensure"),
            read: () => Effect.die("unexpected memory.read"),
            add: () => Effect.die("unexpected memory.add"),
            decide: () => Effect.die("unexpected memory.decide"),
            decisions: () => Effect.die("unexpected memory.decisions"),
            forget: () => Effect.die("unexpected memory.forget"),
            search: () => Effect.die("unexpected memory.search"),
            rules: () => Effect.die("unexpected memory.rules"),
            checkRules: () => Effect.die("unexpected memory.checkRules"),
            editGuard: () => Effect.die("unexpected memory.editGuard"),
            repoMap: () => Effect.die("unexpected memory.repoMap"),
            prompt: () => Effect.succeed({ system: [], project: [] }),
          detectSecrets: () => false,
        }),
      ),
    ),
